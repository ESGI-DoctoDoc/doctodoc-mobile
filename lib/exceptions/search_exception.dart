...
class SearchException extends AppException {
  static const defaultCode = 'error.search';
  SearchException({super.code = defaultCode});
    ...
    if (exception is DioException) {
      if (exception.response?.data is Map<String, dynamic>) {
        ...
        if (data.containsKey('code')) {
          return SearchException(code: data['code']);
        }
      }
    }
    return SearchException(code: defaultCode);
  }
}
